...
if($count>0){
    ...
    if($cart_min_value>$cart_total){
        $jsonArr=array('is_error'=>'yes','result'=>$cart_total,'discount'=>'Minimum Order Value '.$cart_min_value);
    }else{
        ...
        $discount = $cart_total-$final_price;
    ...
    $jsonArr=array('is_error'=>'yes','result'=>$cart_total,'discount'=>'Coupon Code Invalid');
