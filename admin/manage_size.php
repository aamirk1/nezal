				...
				<div class="card">
					...
					<div class="card-body card-block">
						<div class="form-group">
							...
							<input type="text" name="size" placeholder="Enter your size name" class="form-control" required value="<?php echo $size?>">
						</div>
						<div class="form-group">
							<label for="order_by" class=" form-control-label">Order By</label>
							<input type="text" name="order_by" placeholder="Enter your size name" class="form-control" required value="<?php echo $order_by?>">
						</div>
